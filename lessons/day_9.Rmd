...
2.  More practice [**creating and customizing tables**]{.underline} in R with `gt`.
3.  Practice with `dplyr` [**data manipulation functions**]{.underline} (e.g. `slice()`).
4.  Creating your own [**functions.**]{.underline}
