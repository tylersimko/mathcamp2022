---
title: 'MPA/ID Math Camp 2022: Day #7'
author: "Tyler Simko"
date: '2022-08-22'
output: pdf_document
---
...
Imagine we'd like to merge the `misc` data to this example dataset below of country continents. We would like to have a dataset with rows as students answering the MICS6 survey with continents attached as a new column, but only for countries that are found in the `misc` data (i.e. there should be no countries in your final answer dataset that were not in the original `misc` data. Implement that merge below, and think of a way to verify you have done it correctly:
